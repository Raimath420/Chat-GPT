...
const API_KEY ='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'
...
async function submit(){
    ...
    question.innerHTML = capitalizeFirstLetter(input)
    ...
    try{
        ...
        if(data.choices[0].message.content){
            ...
            history.append(para)
            para.innerHTML = capitalizeFirstLetter(input)
...
typrewritter()
 ...
 function lightMode(){
    ...
    document.getElementById('light-div').style.backgroundColor = 'black'
    document.getElementById('dark-div').style.backgroundColor = '#202123'
    document.getElementById('light-div').style.border="2px solid #3a3a3a"
    document.getElementById('dark-div').style.border="none"
 ...
 function darkMode(){
    ...
    document.getElementById('dark-div').style.backgroundColor = 'black'
    document.getElementById('light-div').style.backgroundColor = '#202123'
    document.getElementById('dark-div').style.border="2px solid #3a3a3a"
    document.getElementById('light-div').style.border="none"
